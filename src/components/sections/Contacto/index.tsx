...
export function Contacto () {
  ...
  return (
    <section id='contacto' className='[@media(max-width:800px)]:pt-[50px] pt-[120px]'>
      <Card>
        <h3 className='text-3xl font-semibold'>Contacto</h3>
        <form onSubmit={handleSubmit} className='flex flex-col justify-center '>
          <label className='mt-5 mb-2 text-gray-400'>Correo</label>
          <input className='outline-none bg-[#333333] p-2 rounded-lg [@media(max-width:800px)]:w-[350px] w-[400px]' type='text' placeholder='tucorreo@123.com' />

          <label className='mt-5 mb-2 text-gray-400'>Mensaje</label>
          <textarea className='outline-none bg-[#333333] p-2 rounded-lg [@media(max-width:800px)]:w-[350px] w-[400px] h-[300px]' />
